...
export default function Contact() {
  return (
    <>
      <div className="py-5 flex items-center justify-between relative rounded-lg w-full bg-background overflow-hidden border">
        <FlickeringGrid
        ...
        <div>
          <form className="flex flex-col space-y-8 w-full container" action="javascript:void(0)">
            ...
            <button className="inline-flex max-w-max gap-x-2 bg-[#171717] items-center py-2 px-10 rounded-md">
              ...
              <span className="font-semibold text-white inline-flex">Send</span>
            </button>
          </form>
        </div>
      </div>
