  ...
  return (
    <div className="bg-[#171717] bug-border">
      <div className="py-10 container">
        ...
        <div className="flex flex-wrap gap-x-12 gap-y-4 items-center justify-center rounded-xl text-white border border-b-0 border-slate-700 p-4 bg-zinc-200 dark:bg-zinc-800 lg:mt-8 mt-5">
          <div className="bg-slate-300 p-2 rounded-lg">
            <svg
              ...
              className="lg:h-28 md:h-28 sm:h-20 h-16 w-auto text-zinc-100 dark:text-zinc-800"
            >
