  ...
  return (
    <div className="bg-[#171717] bug-border">
      <div data-aos="fade-up" data-aos-delay={aosDelay} className="py-10 container">
        ...
        <div className="flex flex-wrap gap-x-12 gap-y-4 items-center justify-center rounded-xl text-white border border-b-0 border-slate-700 p-4 bg-zinc-800 lg:mt-8 mt-5">
